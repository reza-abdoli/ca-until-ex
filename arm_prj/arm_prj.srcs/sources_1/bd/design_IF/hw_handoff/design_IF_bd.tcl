...
################################################################
# This is a generated script based on design: design_IF
#
...
proc create_root_design { parentCell } {
  ...
  set instructionOut_0 [ create_bd_port -dir O -from 31 -to 0 instructionOut_0 ]
  ...
  connect_bd_net -net RegsIfId_0 [get_bd_ports pcOut_0] [get_bd_pins RegsIfId_0/pcOut]
  connect_bd_net -net RegsIfId_0_instructionOut [get_bd_ports instructionOut_0] [get_bd_pins RegsIfId_0/instructionOut]
  connect_bd_net -net branchAddress_0_1 [get_bd_ports branchAddress_0] [get_bd_pins IF_0/branchAddress]
  connect_bd_net -net branchTaken_0_1 [get_bd_ports branchTaken_0] [get_bd_pins IF_0/branchTaken] [get_bd_pins RegsIfId_0/flush]
  connect_bd_net -net clk_0_1 [get_bd_ports clk_0] [get_bd_pins IF_0/clk] [get_bd_pins RegsIfId_0/clk]
  connect_bd_net -net freeze_0_1 [get_bd_ports freeze_0] [get_bd_pins IF_0/freeze] [get_bd_pins RegsIfId_0/freeze]
  connect_bd_net -net rst_0_1 [get_bd_ports rst_0] [get_bd_pins IF_0/rst] [get_bd_pins RegsIfId_0/rst]
