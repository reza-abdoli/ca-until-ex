...
################################################################
# This is a generated script based on design: design_WB
#
...
# source design_WB_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# EXE_Stage, EXE_Stage_Reg, ID_Stage, ID_Stage_Reg, IF, MEM_Stage, MEM_Stage_Reg, RegsIfId, StatusRegister, WB_Stage
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set WB_DestOut_0 [ create_bd_port -dir O -from 3 -to 0 WB_DestOut_0 ]
  set WB_ENOut_0 [ create_bd_port -dir O -from 0 -to 0 WB_ENOut_0 ]
  set WB_ValueOut_0 [ create_bd_port -dir O -from 31 -to 0 WB_ValueOut_0 ]
  ...
  connect_bd_net -net MEM_Stage_Reg_0_ALU_ResOut [get_bd_pins MEM_Stage_Reg_0/ALU_ResOut] [get_bd_pins WB_Stage_0/ALU_ResIn]
  connect_bd_net -net MEM_Stage_Reg_0_DataMemoryOut [get_bd_pins MEM_Stage_Reg_0/DataMemoryOut] [get_bd_pins WB_Stage_0/DataMemoryIn]
  connect_bd_net -net MEM_Stage_Reg_0_DestOut [get_bd_pins MEM_Stage_Reg_0/DestOut] [get_bd_pins WB_Stage_0/WB_DestIn]
  connect_bd_net -net MEM_Stage_Reg_0_MEM_R_ENOut [get_bd_pins MEM_Stage_Reg_0/MEM_R_ENOut] [get_bd_pins WB_Stage_0/MEM_R_ENIn]
  connect_bd_net -net MEM_Stage_Reg_0_WB_ENOut [get_bd_pins MEM_Stage_Reg_0/WB_ENOut] [get_bd_pins WB_Stage_0/WB_ENIn]
  ...
  connect_bd_net -net WB_Stage_0_WB_DestOut [get_bd_ports WB_DestOut_0] [get_bd_pins WB_Stage_0/WB_DestOut]
  connect_bd_net -net WB_Stage_0_WB_ENOut [get_bd_ports WB_ENOut_0] [get_bd_pins WB_Stage_0/WB_ENOut]
  connect_bd_net -net WB_Stage_0_WB_ValueOut [get_bd_ports WB_ValueOut_0] [get_bd_pins WB_Stage_0/WB_ValueOut]
  ...
  connect_bd_net -net clk_0_1 [get_bd_ports clk_0] [get_bd_pins EXE_Stage_0/clk] [get_bd_pins EXE_Stage_Reg_0/clk] [get_bd_pins ID_Stage_0/clk] [get_bd_pins ID_Stage_Reg_0/clk] [get_bd_pins IF_0/clk] [get_bd_pins MEM_Stage_0/clk] [get_bd_pins MEM_Stage_Reg_0/clk] [get_bd_pins RegsIfId_0/clk] [get_bd_pins StatusRegister_0/clk] [get_bd_pins WB_Stage_0/clk]
  ...
  connect_bd_net -net rst_0_1 [get_bd_ports rst_0] [get_bd_pins EXE_Stage_0/rst] [get_bd_pins EXE_Stage_Reg_0/rst] [get_bd_pins ID_Stage_0/rst] [get_bd_pins ID_Stage_Reg_0/rst] [get_bd_pins IF_0/rst] [get_bd_pins MEM_Stage_0/rst] [get_bd_pins MEM_Stage_Reg_0/rst] [get_bd_pins RegsIfId_0/rst] [get_bd_pins StatusRegister_0/rst] [get_bd_pins WB_Stage_0/rst]
