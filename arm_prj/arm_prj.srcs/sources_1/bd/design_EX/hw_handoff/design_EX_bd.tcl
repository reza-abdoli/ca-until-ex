...
################################################################
# This is a generated script based on design: design_EX
#
...
# source design_EX_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# EXE_Stage, EXE_Stage_Reg, ID_Stage, ID_Stage_Reg, IF, RegsIfId, StatusRegister
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net EXE_Stage_Reg_0_ALU_ResOut [get_bd_ports ALU_ResOut_0] [get_bd_pins EXE_Stage_Reg_0/ALU_ResOut]
