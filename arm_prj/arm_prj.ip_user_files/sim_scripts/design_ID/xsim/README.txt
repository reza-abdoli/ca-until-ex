...
#
# Generated by export_simulation on Fri May 16 21:51:44 +0330 2025
#
################################################################################
...
'-reset_run' switch to the './design_ID.sh' script.

./design_ID.sh -reset_run
...
./design_ID.sh -noclean_files

For more information on the script, please type './design_ID.sh -help'.
