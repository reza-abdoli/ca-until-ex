...
################################################################
# This is a generated script based on design: design_ID
#
...
# source design_ID_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# ID_Stage, ID_Stage_Reg, IF, RegsIfId
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set Imm24Out_0 [ create_bd_port -dir O -from 23 -to 0 Imm24Out_0 ]
  set PCOut_0 [ create_bd_port -dir O -from 31 -to 0 PCOut_0 ]
  ...
  connect_bd_net -net ID_Stage_Reg_0_Imm24Out [get_bd_ports Imm24Out_0] [get_bd_pins ID_Stage_Reg_0/Imm24Out]
  connect_bd_net -net ID_Stage_Reg_0_PCOut [get_bd_ports PCOut_0] [get_bd_pins ID_Stage_Reg_0/PCOut]
  ...
  connect_bd_net -net branchTaken_0_1 [get_bd_ports branchTaken_0] [get_bd_pins ID_Stage_Reg_0/clr] [get_bd_pins IF_0/branchTaken] [get_bd_pins RegsIfId_0/flush]
  connect_bd_net -net clk_0_1 [get_bd_ports clk_0] [get_bd_pins ID_Stage_0/clk] [get_bd_pins ID_Stage_Reg_0/clk] [get_bd_pins IF_0/clk] [get_bd_pins RegsIfId_0/clk]
  connect_bd_net -net freeze_0_1 [get_bd_ports freeze_0] [get_bd_pins ID_Stage_Reg_0/en] [get_bd_pins IF_0/freeze] [get_bd_pins RegsIfId_0/freeze]
  connect_bd_net -net rst_0_1 [get_bd_ports rst_0] [get_bd_pins ID_Stage_0/rst] [get_bd_pins ID_Stage_Reg_0/rst] [get_bd_pins IF_0/rst] [get_bd_pins RegsIfId_0/rst]
