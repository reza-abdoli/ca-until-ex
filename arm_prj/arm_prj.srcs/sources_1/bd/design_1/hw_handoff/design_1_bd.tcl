...
# module references:
# Adder, InstructionMemory, Mux2to1, ProgramCounter, register, register, register, register
...
proc create_root_design { parentCell } {
  ...
  set pout_0 [ create_bd_port -dir O -from 31 -to 0 pout_0 ]
  ...
  connect_bd_net -net AdderIf_out [get_bd_pins Adder/out] [get_bd_pins Mux2to1_0/in0]
  connect_bd_net -net InstructionMemory_0_mem [get_bd_pins InstructionMemory_0/mem] [get_bd_pins register_0/pin]
  connect_bd_net -net Mux2to1_0_out [get_bd_pins Mux2to1_0/out] [get_bd_pins ProgramCounter_0/pcIn]
  connect_bd_net -net ProgramCounter_0_pcOut [get_bd_pins Adder/b] [get_bd_pins InstructionMemory_0/memAddr] [get_bd_pins ProgramCounter_0/pcOut]
  connect_bd_net -net clk_0_1 [get_bd_ports clk_0] [get_bd_pins ProgramCounter_0/clk] [get_bd_pins register_0/clk] [get_bd_pins register_1/clk] [get_bd_pins register_2/clk] [get_bd_pins register_3/clk]
  connect_bd_net -net register_0_pout [get_bd_pins register_0/pout] [get_bd_pins register_1/pin]
  connect_bd_net -net register_1_pout [get_bd_pins register_1/pout] [get_bd_pins register_2/pin]
  connect_bd_net -net register_2_pout [get_bd_pins register_2/pout] [get_bd_pins register_3/pin]
  connect_bd_net -net register_3_pout [get_bd_ports pout_0] [get_bd_pins register_3/pout]
  connect_bd_net -net rst_0_1 [get_bd_ports rst_0] [get_bd_pins ProgramCounter_0/rst] [get_bd_pins register_0/rst] [get_bd_pins register_1/rst] [get_bd_pins register_2/rst] [get_bd_pins register_3/rst]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins Adder/a] [get_bd_pins xlconstant_0/dout]
